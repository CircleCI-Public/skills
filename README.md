...
- `circleci-smarter-testing-onboarding` cases: ensure Smarter Testing, testsuite, and `test-suites.yml` prompts route to `circleci-smarter-testing-onboarding` (explicit + implicit).
...
- `smarter-testing-explicit-smoke`: validate explicit `$circleci-smarter-testing-onboarding` prompt selects `circleci-smarter-testing-onboarding`.
...
- `smarter-testing-explicit` / `smarter-testing-implicit`: validate `$circleci-smarter-testing-onboarding` and Smarter Testing migration prompts.
